...
class MvCamera():
    ...
    def MV_CC_RegisterEventCallBackEx(self, pEventName, EventCallBackFun, pUser):
        ...
        MvCamCtrldll.MV_CC_RegisterEventCallBackEx.restype = c_uint        return MvCamCtrldll.MV_CC_RegisterEventCallBackEx(self.handle, pEventName.encode('ascii'), EventCallBackFun, pUser)
